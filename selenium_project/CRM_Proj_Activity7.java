...
public class CRM_Proj_Activity7 {
	...
	public void f() throws InterruptedException {
		...
		// get phone number
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//div[contains(@id,'ui-id-5')]/span[@class='phone']")));
		String phone = driver.findElement(By.xpath("//div[contains(@id,'ui-id-5')]/span[@class='phone']")).getText();
